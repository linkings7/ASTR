...
cfg.MODEL.BACKBONE.DEC_LOCATION = 12
cfg.MODEL.BACKBONE.MULTI_MODE = 0
cfg.MODEL.BACKBONE.NUM_DECODER = 1 # Ablation Study 4.3.4
cfg.MODEL.BACKBONE.PROMPT_SIZE = 5 # Ablation Study 4.3.6
